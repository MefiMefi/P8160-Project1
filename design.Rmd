...
All simulation scenarios are displayed in the table below:
...
By repeating each of the above simulation process 500 times, we get *** survival datasets with sample size ranging from ***. 
