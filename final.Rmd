...
gompertz_haz <- function(t, alpha = 0.3, lambda = 0.8) lambda * exp(alpha* t)
...
gompertz_surv <- function(t, alpha = 1.5, lambda = 0.8) exp(lambda/alpha*(1-exp(alpha*t)))
...
```
```{r}
simdat2 = function(n, p, lambda = 0.5, gamma = 1.5, eff = list()) {
  # randomly assign group
  x1 = rbinom(n, 1, 0.5)
