...
**Bias:**\
The bias is the average difference between the $\beta$ we got from the simulation and the real $\beta$. The bias measure deviates the desired prediction of the learning algorithm from the true result, i.e., it portrays the fitting ability of the learning algorithm itself. The larger the bias, the greater the degree of difference between the estimated treatment effects $\beta$ and the real $\beta$, and the less accuracy the simulation is.\
